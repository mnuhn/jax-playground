...
python3 train_ppo.py \
  ...
  --rule_reward_fac=0.01 \
  --suffix=rewardmodel2c \
  --low_rule_reward_override=True \
  --use_score_scaling=True \
  --reward_model=./data/mix24.base.reward-model2-final
...
python3 train_ppo.py \
  ...
  --rule_reward_fac=0.01 \
  --suffix=reward-mixing13-augmented8 \
  --low_rule_reward_override=True \
  --use_score_scaling=True \
...
python3 train_ppo.py \
  --prompts_fn=data/ppo_mix.shuffled.txt \
  --model=./data/mix23.txt.augmented3.model-final \
  --max_ppo_steps=250 \
  --max_len=100 \
  --batch_size=128 \
  --target_kl=10.0 \
  --learning_rate=0.000010 \
  --rule_reward_fac=0.01 \
  --suffix=reward-mixing13-augmented9 \
  --low_rule_reward_override=True \
  --use_score_scaling=True \
  --reward_model=./data/mix22.extended.txt.model2-final.lr0.0001-wd0.0-ep2-margin25.0-reward-model-head4-final
