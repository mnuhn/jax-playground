...
def draw(x_values_history, history, x_values_prediction, predictions, last_predictions, fn):
  plt.clf()
  ...
  x_ticks = [tick for tick in axs.get_xticks() if tick < x_values_prediction[-12]]
